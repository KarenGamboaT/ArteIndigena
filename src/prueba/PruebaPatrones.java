...
//        add(new PanelPatronMosaico());
    ...
    class PanelPatronZigZag extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            int tamanoFigura = 30;
            PatronZigZag zigzag = new PatronZigZag(100, 100, tamanoFigura, color,0);
    ...
    @Override
        protected void paintComponent(Graphics g) {
            ...
            Circulo circulo = new Circulo (5,5,50, Color.black);
            Cuadrado cuadrado1 = new Cuadrado(5,5,50,Color.black);
            Triangulo triangulo = new Triangulo (5,5,50, Color.black);
            
            PatronMosaico mosaico = new PatronMosaico(100, 100, 50, triangulo);
    ...
    class PanelPatronAlternante extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            super.paintComponent(g);
            PatronAlternante alternante = new PatronAlternante(5, 5, 50, "Rombo", Color.GREEN, "Circulo", Color.ORANGE);
